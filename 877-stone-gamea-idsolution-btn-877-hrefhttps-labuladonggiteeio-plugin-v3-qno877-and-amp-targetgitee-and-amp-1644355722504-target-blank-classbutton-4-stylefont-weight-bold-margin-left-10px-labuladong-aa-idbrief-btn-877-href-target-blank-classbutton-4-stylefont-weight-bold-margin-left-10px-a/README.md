<h2><a href="https://leetcode.com/problems/stone-game/">877. Stone Game<a id="solution_btn_877" href="https://labuladong.gitee.io/plugin-v3/?qno=877&amp;target=gitee&amp;_=1644355722504" target="_blank" class="button-4" style="font-weight: bold; margin-left: 10px;">labuladong 题解</a><a id="brief_btn_877" href="#" target="_blank" class="button-4" style="font-weight: bold; margin-left: 10px;">思路</a></a></h2><h3>Medium</h3><hr><div><p>Alice and Bob play a game with piles of stones. There are an <strong>even</strong> number of piles arranged in a row, and each pile has a <strong>positive</strong> integer number of stones <code>piles[i]</code>.</p>
